...
export default function SellHousePage() {
  ...
  useEffect(() => {
    if (!loading && !user) {
      router.push("/auth/login?redirectTo=/sell/house");
    }
  }, [user, loading, router]);
  ...
  function validateStep(): boolean {
    switch (step) {
      ...
      case 1: {
        if (!form.bedrooms || Number(form.bedrooms) < 1 || Number(form.bedrooms) > 20) {
          toast.error("Bedrooms must be between 1 and 20");
          return false;
        }
        if (!form.bathrooms || Number(form.bathrooms) < 1 || Number(form.bathrooms) > 10) {
          toast.error("Bathrooms must be between 1 and 10");
          return false;
        }
              ...
              <>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="e.g. Gym, Swimming Pool, Garden (comma-separated)"
                  />
                </div>
              </>
            )}
                ...
                <div>
                  ...
                  <dl className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-2 text-sm">
                    <div>
                      ...
                      <dd className="font-medium">{form.bedrooms}</dd>
                    </div>
                    <div>
                      <dt className="text-muted-foreground">Bathrooms</dt>
                      <dd className="font-medium">{form.bathrooms}</dd>
                    </div>
                    <div>
                    ...
                    {form.year_built && (
                      <div>
                        ...
                        <dd className="font-medium">{form.year_built}</dd>
                      </div>
                    )}
                    {form.amenities && (
                      <div className="sm:col-span-2">
